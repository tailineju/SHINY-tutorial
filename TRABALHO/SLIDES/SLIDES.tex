...
\begin{frame}{RESULTADO}
\protect\hypertarget{resultado-2}{}

\includegraphics[width=4.4in]{imagens/d1}

\end{frame}

\begin{frame}[fragile]{PRÓXIMO PASSO}
\protect\hypertarget{proximo-passo-2}{}
...
\KeywordTok{library}\NormalTok{(shinydashboard)}
\NormalTok{ui <-}\StringTok{ }\KeywordTok{dashboardPage}\NormalTok{(}
  \KeywordTok{dashboardHeader}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Basic dashboard"}\NormalTok{),}
  \KeywordTok{dashboardSidebar}\NormalTok{(),}
  \KeywordTok{dashboardBody}\NormalTok{(}
    \KeywordTok{fluidRow}\NormalTok{(}
      \KeywordTok{box}\NormalTok{(}\KeywordTok{plotOutput}\NormalTok{(}\StringTok{"plot1"}\NormalTok{, }\DataTypeTok{height =} \DecValTok{250}\NormalTok{)),}
      \KeywordTok{box}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Controls"}\NormalTok{, }
...
\begin{frame}{RESULTADO}
\protect\hypertarget{resultado-3}{}
...
\begin{frame}[fragile]{PRÓXIMO PASSO}
\protect\hypertarget{proximo-passo-3}{}
...
\NormalTok{ui <-}\StringTok{ }\KeywordTok{dashboardPage}\NormalTok{(}
  \KeywordTok{dashboardHeader}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Basic dashboard"}\NormalTok{),}
  \KeywordTok{dashboardSidebar}\NormalTok{(}\KeywordTok{sidebarMenu}\NormalTok{(}
    \KeywordTok{menuItem}\NormalTok{(}\StringTok{"Dashboard"}\NormalTok{, }\DataTypeTok{tabName =} \StringTok{"dashboard"}\NormalTok{, }\DataTypeTok{icon =} \KeywordTok{icon}\NormalTok{(}\StringTok{"dashboard"}\NormalTok{)),}
    \KeywordTok{menuItem}\NormalTok{(}\StringTok{"Widgets"}\NormalTok{, }\DataTypeTok{tabName =} \StringTok{"widgets"}\NormalTok{, }\DataTypeTok{icon =} \KeywordTok{icon}\NormalTok{(}\StringTok{"th"}\NormalTok{))))}
  \KeywordTok{dashboardBody}\NormalTok{(}
    \KeywordTok{fluidRow}\NormalTok{(}
      \KeywordTok{box}\NormalTok{(}\KeywordTok{plotOutput}\NormalTok{(}\StringTok{"plot1"}\NormalTok{, }\DataTypeTok{height =} \DecValTok{250}\NormalTok{)),}
      \KeywordTok{box}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Controls"}\NormalTok{, }
...
\begin{frame}{RESULTADO}
\protect\hypertarget{resultado-4}{}

\includegraphics[width=4.4in]{imagens/d3}

\end{frame}

\hypertarget{publicacao}{%
\section{PUBLICAÇÃO}\label{publicacao}}
...
\item
  \textbf{shinydashboard}. Disponível em:
  \url{https://rstudio.github.io/shinydashboard/get_started.html}.
